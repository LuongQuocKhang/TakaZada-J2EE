...
<%
	VGA _vga = (VGA)request.getAttribute("VGA");
%>
<style>
    table td {
        color: black;
    ...
    <div class="container">
        ...
        <div class="col-md-4 single-left">
            <div class="flexslider">
                <ul class="slides">
                    <% out.print("<li data-thumb=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/VGA/" + _vga.Image.replace(" ", "%20") + "\"" + ">"); %>
                        <div class="thumb-image">
                        	<% out.print("<img src=\""+ request.getAttribute("domainname") + "/Resources/Content/Pictures/VGA/" + _vga.Image.replace(" ", "%20") + "\"" + "data-imagezoom=\"true\" class=\"img-responsive\"> "); %>
                        </div>
                    </li>
                    <% out.print("<li data-thumb=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/VGA/" + _vga.Image.replace(" ", "%20") + "\"" + ">"); %>
                        <div class="thumb-image"> 
                        	<% out.print("<img scr=\""+ request.getAttribute("domainname") + "/Resources/Content/Pictures/VGA/" + _vga.Image.replace(" ", "%20") + "\"" + "data-imagezoom=\"true\" class=\"img-responsive\"> "); %>
                        </div>
                    </li>
                    <% out.print("<li data-thumb=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/VGA/" + _vga.Image.replace(" ", "%20") + "\"" + ">"); %>
                        <div class="thumb-image"> 
        ...
        <div class="col-md-8 single-right">
            ...
            <div class="simpleCart_shelfItem">
                <p><i class="item_price"></i> <% out.print(_vga.Price); %></p>
        ...
        <div class="sap_tabs">
            <div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
                ...
                <div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
                    <h3><% out.print(_vga.Name); %></h3>
                    <p>
                        <% out.print(_vga.Description); %>
                    </p>
                </div>
                <input type="hidden" name="Name" id="Name" value="<% out.print(_vga.Name); %>" />
                <input type="hidden" name="Image" id="Image" value="<% out.print(_vga.Image); %>" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="column-span:all;">
                                    <% out.print(_vga.ChipsetManufacturer); %>
                                </td>
                            </tr>
                            <tr>
                                <td>
...
<div class="w3l_related_products">
    <div class="container">
        ...
        <ul id="flexiselDemo2">         
        <% 
        	ArrayList<VGA> TheSameTrademark = (ArrayList<VGA>)request.getAttribute("TheSameTrademark");
        			...
        			out.print("<div class=\"w3l_related_products_grid\">");
        				out.print("<div class=\"agile_ecommerce_tab_left dresses_grid\">");
        					out.print("<div class=\"hs-wrapper3\">");
        						out.print("<img src=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/VGA/" + TheSameTrademark.get(i).Image + "\"" + "alt=\" \" class=\"img-responsive\">");
        					out.print("</div>");
        					out.print("<h5>" + "<a href=\"" + request.getAttribute("domainname") + "/VGADetail/" + TheSameTrademark.get(i).Id + "\"> " +  TheSameTrademark.get(i).Name + "</a></h5>");
            ...
            $.ajax(
                {
                    ...
                    method: "POST",
                    data: { "type": "VGA", "ItemId": "<% out.print(_vga.Id); %>", "Quantity": $(".value1").text(), "price": "<% out.print(_vga.Price); %>", "Id": "<% out.print(_vga.Id); %>", "Name": $("#Name").val(), "Image": $("#Image").val() },
