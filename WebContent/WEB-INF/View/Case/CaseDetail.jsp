...
<%
	Case _case = (Case)request.getAttribute("Case");
%>
<style>
    table td {
        color: black;
    ...
    <div class="container">
        ...
        <div class="col-md-4 single-left">
            <div class="flexslider">
                <ul class="slides">
                    <% out.print("<li data-thumb=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/Case/" + _case.Image.replace(" ", "%20") + "\"" + ">"); %>
                        <div class="thumb-image">
                        	<% out.print("<img src=\""+ request.getAttribute("domainname") + "/Resources/Content/Pictures/Case/" + _case.Image.replace(" ", "%20") + "\"" + "data-imagezoom=\"true\" class=\"img-responsive\"> "); %>
                        </div>
                    </li>
                    <% out.print("<li data-thumb=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/Case/" + _case.Image.replace(" ", "%20") + "\"" + ">"); %>
                        <div class="thumb-image"> 
                        	<% out.print("<img scr=\""+ request.getAttribute("domainname") + "/Resources/Content/Pictures/Case/" + _case.Image.replace(" ", "%20") + "\"" + "data-imagezoom=\"true\" class=\"img-responsive\"> "); %>
                        </div>
                    </li>
                    <% out.print("<li data-thumb=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/Case/" + _case.Image.replace(" ", "%20") + "\"" + ">"); %>
                        <div class="thumb-image"> 
        ...
        <div class="sap_tabs">
            <div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
                ...
                <div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">         
                    <% out.print("<h3>" + _case.Name + "</h3>"); %>
                    <p>
                        <% out.print(_case.Description); %>
                    </p>
                </div>
                <input type="hidden" name="Name" id="Name" value="<% out.print(_case.Name); %>" />
                <input type="hidden" name="Image" id="Image" value="<% out.print(_case.Image); %>" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="column-span:all;">
                                    <% out.print(_case.WarrantyPeriod); %>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<div class="w3l_related_products">
    <div class="container">
        ...
        <ul id="flexiselDemo2">
        <% 
        	ArrayList<Case> TheSameTrademark = (ArrayList<Case>)request.getAttribute("TheSameTrademark");
        			...
        			out.print("<div class=\"w3l_related_products_grid\">");
        				out.print("<div class=\"agile_ecommerce_tab_left dresses_grid\">");
        					out.print("<div class=\"hs-wrapper3\">");
        						out.print("<img src=\"" + request.getAttribute("domainname") + "/Resources/Content/Pictures/Case/" + TheSameTrademark.get(i).Image + "\"" + "alt=\" \" class=\"img-responsive\">");
        					out.print("</div>");
        					out.print("<h5>" + "<a href=\"" + request.getAttribute("domainname") + "/CaseDetail/" + TheSameTrademark.get(i).Id + "\"> " +  TheSameTrademark.get(i).Name + "</a></h5>");
    ...
    $.ajax(
        {
            ...
            method: "POST",
            data: { "type": "Case", "ItemId": "<% out.print(_case.Id); %>", "Quantity": $(".value1").text(), "price": "<% out.print(_case.Price); %>", "Id": "<% out.print(_case.Id); %>", "Name": $("#Name").val(), "Image": $("#Image").val() },
